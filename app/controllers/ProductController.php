...
"jpeg" && $imageFileType != "gif" && $imageFileType != "jfif" && $imageFileType != "webp") {
throw new Exception("Chỉ cho phép các định dạng JPG, JPEG, JFIF, PNG và GIF.");
}
// Lưu file
...
if (!isset($_SESSION['cart'])) {
    ...
    header('Location: /lab02/Product/cart');
    }
...
header('Location: /lab02/Product/orderConfirmation');
} catch (Exception $e) {
